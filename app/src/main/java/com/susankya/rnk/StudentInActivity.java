...
public class StudentInActivity extends AppCompatActivity implements FragmentCodes {

    ViewPager viewPager;
    private Button next, pre;
    private SharedPreferences sp;
    public static ArrayList<SearchItem> searchItemArrayList = new ArrayList<>();
    public static StudentInActivity thisAct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thisAct = StudentInActivity.this;
        if (getSharedPreferences("visitedOnce", MODE_PRIVATE).getBoolean("visited", false)
                && !getSharedPreferences("rememberlogin", Context.MODE_PRIVATE).getBoolean("isloggedin", false) && false) {
            startActivity(new Intent(StudentInActivity.this, StartActivity.class));
            this.finish();
            ...
            startActivity(new Intent(StudentInActivity.this, NavDrawerActivity.class));
            this.finish();
        } else {
            setContentView(R.layout.activity_first_time);
            Fragment f = new FirstLoginFragment();
            Bundle b = new Bundle();
