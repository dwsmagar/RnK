...
public class ListProvider implements RemoteViewsFactory,FragmentCodes {
    ...
    public ListProvider(Context context, Intent intent) {
        ...
        day=intent.getIntExtra("dayBoy",1);
        //Log.d(TAG, "ListProvider: " +day);
        populateListItem();
    }

    private void populateListItem() {
        listItemList=insertIntoView(day,context);
    }
    ...
    */
    ...
    public RemoteViews getViewAt(int position) {
        final RemoteViews remoteView = new RemoteViews(
                context.getPackageName(), R.layout.material_routine_layout);
    ...
    public static ArrayList<RoutineInfo> insertIntoView(int day,Context c)
    {
        ...
        JSONArray routineArray=getRoutine(2,c);
